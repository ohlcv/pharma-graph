...
export const NODE_TIER_STYLE: Record<string, { bgColor: string; glow: string }> = {
  basic:      { bgColor: '#cbd5e1', glow: 'rgba(203,213,225,0.25)' },  // 灰蓝 — 基础层
  drug:       { bgColor: '#93c5fd', glow: 'rgba(147,197,253,0.30)' },  // 浅蓝 — 药物层
  disease:    { bgColor: '#fca5a5', glow: 'rgba(252,165,165,0.30)' },  // 浅红 — 疾病层
  management: { bgColor: '#fde68a', glow: 'rgba(253,230,138,0.30)' },  // 浅黄 — 管理层
  service:    { bgColor: '#6ee7b7', glow: 'rgba(110,231,183,0.30)' },  // 浅青 — 服务层
  legal:      { bgColor: '#d8b4fe', glow: 'rgba(216,180,254,0.30)' },  // 浅紫 — 法规层
};
